...
sudo chown -R briller:briller /home/braintracer
sudo chmod 700 /home/braintracer

sudo chown -R briller:briller /home/braintracer/.ssh
sudo chmod 755 /home/braintracer/.ssh

```
```bash\
sudo visudo

geunbon ALL=(ALL) NOPASSWD: /usr/bin/apt-get
