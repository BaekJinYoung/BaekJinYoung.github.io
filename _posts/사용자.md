...
sudo chown kayaru:kayaru ~/.ssh/authorized_keys
...
```bash
sudo mkdir -p /home/rond/laravel/vendor
sudo chown -R $(whoami):$(whoami) /home/rond/laravel
sudo chmod -R 755 /home/rond/laravel
